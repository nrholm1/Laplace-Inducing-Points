...
#%%
# ! banana # matrix free sampling quality

st256_slq40 = np.array([
    [0.30051,0.30936,0.29082],
    [ 96.875, 90.625, 96.875],
    [0.16190,0.16985,0.15176],
    [0.20182,0.17367,0.19663],
    [ 92.932, 94.421, 97.046],
])

st256_slq40.mean(1), st256_slq40.std(1)

#%%
# ! banana # matrix free sampling quality

st256_slq10 = np.array([
    [0.38615,0.40742,0.40540],
    [ 96.875, 93.750, 96.875],
    [0.21907,0.23775,0.23625],
    [0.27249,0.28704,0.28481],
    [94.299, 92.664, 93.250],
])


st256_slq10.mean(1), st256_slq10.std(1)